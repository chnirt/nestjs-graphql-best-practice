...
export abstract class IQuery {
	...
	abstract ordersCountByMenu(
		menuId: string
	): OrderCount[] | Promise<OrderCount[]>
	...
	abstract siteShopsBySiteId(
		siteId: string
	): SiteShopResponse[] | Promise<SiteShopResponse[]>
