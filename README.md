...
**TL;DR:** Structure your solution by self-contained components

## [✔] 1.2 Layer your components, keep Express within its boundaries

**TL;DR:** Separate component code into layers: web, services, and DAL

## [✔] 1.3 Wrap common utilities as npm packages

**TL;DR:** Sharing your own common utilities across environments and components

## [✘] No neccessary - 1.4 Separate Express 'app' and 'server'

**TL;DR:** test your API in-process using supertest (popular testing package)
